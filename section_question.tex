...
Cho một dãy các mệnh giá tiền xu \code{int a[]} có kích thước \code{m} và một món hàng có giá tiền là \code{n} (xu). Hãy tìm ra cách lấy các đồng xu mang những mệnh giá đã cho (một mệnh giá có thể lấy một hoặc nhiều đồng xu) để trả tiền cho món hàng đó sao cho \textit{số lượng đồng xu là nhỏ nhất}?
