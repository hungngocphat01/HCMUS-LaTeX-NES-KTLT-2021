...
Giả sử ta có \code{a = \{7, 3, 6, 2\}} và \code{n = 8}. Để biết được các phần tử nào cộng lại có giá trị là 8, ta làm theo các bước sau:
\begin{itemize}
...
Ta lần lượt lấy 8 trừ cho các phần tử trong \code{a}.
